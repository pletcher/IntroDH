...
absence. More than one unexcused absence will negatively impact your participation
grade.
...
**NEVER** submit AI-generated work as your own. To do so is considered a
...
1. You _must_ cite all uses of AI. See suggestions from the [Chicago Manual of
...
2. You must provide access everything generated by the model that pertains to the assignment. (A link to your chat transcript is fine.)

Failure to do follow these rules will result in an automatic failure of the assignment.
...
- **Homework**
  - Egan, Patrick and Órla Murphy. "Sharing as CARE and FAIR in the Digital
    Humanities." (Bloomsbury Handbook to Digital Humanities [BHDH] pp. 267–272)
